...
wget -N  http://www.repeatmasker.org/RepeatMasker-open-4-0-7.tar.gz
wget -N  https://github.com/egateam/egavm/releases/download/20170907/repeatmaskerlibraries-20140131.tar.gz
wget -N  https://linuxbrew.bintray.com/bottles/blast-2.7.1.x86_64_linux.bottle.tar.gz
