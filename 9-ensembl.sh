...
if [ ! -e $HOME/prepare/resource/ensembl-${ENSEMBL_VERSION}.tar.gz ];
then
...
echo "==> ensembl"
tar xfz $HOME/prepare/resource/ensembl-${ENSEMBL_VERSION}.tar.gz ensembl-release-${ENSEMBL_VERSION}/modules/Bio/EnsEMBL
...
tar xfz $HOME/prepare/resource/ensembl-compara-${ENSEMBL_VERSION}.tar.gz ensembl-compara-release-${ENSEMBL_VERSION}/modules/Bio/EnsEMBL
...
tar xfz $HOME/prepare/resource/ensembl-variation-${ENSEMBL_VERSION}.tar.gz ensembl-variation-release-${ENSEMBL_VERSION}/modules/Bio/EnsEMBL
